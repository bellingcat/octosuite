...
class CsvLogger:
    ...
    def  log_org_profile(response):
        ...
        if prompt == "yes":
            ...
            logging.info(LogRoller.logging_skipped.format(prompt))
            xprint(f"{MessagePrefix.info} {LogRoller.logging_skipped.format(prompt)}")
    ...
    def log_repo_contributors(contributor, repo_name):
        ...
        if prompt == "yes":
            ...
            logging.info(LogRoller.logging_skipped.format(prompt))
            print(f"{MessagePrefix.info} {LogRoller.logging_skipped}\n")
